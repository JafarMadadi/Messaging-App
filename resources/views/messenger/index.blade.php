...
<section class="wsus__chat_app">
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            <form action="#">
                                ...
                                <div class="file">
                                    <img src="../../../public/assets/images/upload_img.jpg" alt="Upload" class="img-fluid">
    ...
    <div class="wsus__chat_area">
        ...
        <div class="wsus__chat_area_body">
            ...
            <div class="wsus__single_chat_area">
                <div class="wsus__single_chat chat_right">
                    <a class="venobox" data-gall="gallery01" href="../../../public/assets/images/chat_img.png">
                        <img src="../../../public/assets/images/chat_img.png" alt="gallery1" class="img-fluid w-100">
                    </a>
                    <span class="time"> 5h ago</span>
                    <a class="action" href="#"><i class="fas fa-trash"></i></a>
                </div>
